...
create_graph(IFH, E, G) ->
    ...
    Val1 = maps:get(U,G,[]) ++ [{V,W}],
    Val2 = maps:get(V,G,[]) ++ [{U,W}],
    G1 = maps:put(U, Val1, G),
    G2 = maps:put(V, Val2, G1),
    create_graph(IFH, E-1, G2).
...
%compute_sssp(P, V, E, G, S, D) ->
%    io:format("[INFO] Running Dijkstra on input graph~n"),
%    D1 = setelement(S,D,0),
%    D2 = relax(1, V, E, G, D1),
%    {Status, D2}.
%
